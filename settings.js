jQuery(document).ready(function($) {
    ...
    jQuery( '#jmayt_settings .subsubsub a.tab' ).click( function ( e ) {
        ...
        if ( jQuery( this ).hasClass( 'all' ) ) {
            jQuery( '#jmayt_settings h3, #jmayt_settings form p, #jmayt_settings table.form-table, p.submit' ).show();
        ...
        jQuery( '#jmayt_settings h3, #jmayt_settings form > p:not(".submit"), #jmayt_settings table' ).hide();
